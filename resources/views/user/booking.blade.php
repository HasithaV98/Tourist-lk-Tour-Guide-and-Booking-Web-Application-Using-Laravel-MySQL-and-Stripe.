                    ...
                    <div class="col-md-6">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control bg-transparent" placeholder="Special Request" name="request" id="message" style="height: 100px"></textarea>
                                        <label for="message">Special Request</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <a href="" class="btn btn-outline-light w-100 py-3" type="submit">Book Now</a>
                                </div>
                            </div>
                        </form>
